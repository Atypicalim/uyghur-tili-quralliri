...
class _UyghurLanguageTools_LA_Class:
    _hx_class_name = "_UyghurLanguageTools.LA_Class"
...
class Reshaper:
    ...
    def ProLA_HAMZE(self,aWord):
        ...
        while (_g_current < len(_g_array)):
            ...
            if (i == ((len(arr) - 1))):
                ...
                skipNext = False
                continue
            elif ((_hx_map.h.get(i,None) == _UyghurLanguageTools_UyghurLanguageTools_Fields_.la1.base2) and ((_hx_map.h.get((i + 1),None) == _UyghurLanguageTools_UyghurLanguageTools_Fields_.la1.base1))):
                x = _UyghurLanguageTools_UyghurLanguageTools_Fields_.la1.ex
                result.append(x)
                skipNext = True
            elif ((_hx_map.h.get(i,None) == _UyghurLanguageTools_UyghurLanguageTools_Fields_.la2.base2) and ((_hx_map.h.get((i + 1),None) == _UyghurLanguageTools_UyghurLanguageTools_Fields_.la2.base1))):
                x1 = _UyghurLanguageTools_UyghurLanguageTools_Fields_.la2.ex
                result.append(x1)
                skipNext = True
            else:
        ...
        if (len(aWord) < 2):
            result.append(aWord)
        elif (not (((_hx_map.h.get((len(arr) - 2),None) == _UyghurLanguageTools_UyghurLanguageTools_Fields_.la1.base1) and ((_hx_map.h.get((len(arr) - 1),None) == _UyghurLanguageTools_UyghurLanguageTools_Fields_.la1.base2))))):
            if (not (((_hx_map.h.get((len(arr) - 2),None) == _UyghurLanguageTools_UyghurLanguageTools_Fields_.la2.base1) and ((_hx_map.h.get((len(arr) - 1),None) == _UyghurLanguageTools_UyghurLanguageTools_Fields_.la2.base2))))):
                x = _hx_map.h.get((len(arr) - 1),None)
                result.append(x)
        return self.arrayToString(result)

    def getExChar(self,character,alphabet):
        index = self.containsInArray(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_BASE,character)
        if (index > -1):
            if (alphabet == UyHarp.BASH):
                return python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_BEGIN, index)
            elif (alphabet == UyHarp.OTTURA):
                return python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_MIDDLE, index)
            elif (alphabet == UyHarp.AHIR):
                return python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_END, index)
            elif (alphabet == UyHarp.YALGHUZ):
                return python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_SINGLE, index)
        return character
    ...
    def toExttended(self,text):
        ...
        result = []
        if (len(text) == 1):
            index = self.containsInArray(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_BASE,text)
            if (index == -1):
                return ""
            else:
                return python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_SINGLE, index)
        if (len(text) == 2):
            ...
            if (self.containsInArray(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_FRIENDLY,char1) > -1):
        ...
        while (_g_current < len(_g_array)):
            ...
            lastCharIndex = self.containsInArray(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_BASE,lastChar)
            currentIndex = self.containsInArray(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_BASE,currentChar)
            nextIndex = self.containsInArray(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_BASE,nextChar)
            currentCharExt = None
            if (currentIndex == -1):
                currentCharExt = currentChar
            elif (self.containsInArray(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_FRIENDLY,lastChar) > -1):
                if (nextIndex > -1):
        ...
        solKolExt = None
        if (self.containsInArray(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_FRIENDLY,_hx_map.h.get((len(array) - 2),None)) > -1):
    ...
    def toBasical(self,text):
        if (len(text) == 0):
            return ""
        _hx_map = _UyghurLanguageTools_UyghurLanguageTools_Fields_.REPLACE_MAP
        _g_map = _hx_map
        _g_keys = _hx_map.keys()
        while _g_keys.hasNext():
            key = _g_keys.next()
        ...
        while (_g_current < len(_g_array)):
            ...
            _g2_current = 0
            _g2_array = _UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_BASE
            while (_g2_current < len(_g2_array)):
                ...
                j = _g3_key
                w = _g3_value
                isA = (python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_END, j) == _hx_map.h.get(i,None))
                isB = (python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_BEGIN, j) == _hx_map.h.get(i,None))
                isO = (python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_MIDDLE, j) == _hx_map.h.get(i,None))
                isY = (python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_SINGLE, j) == _hx_map.h.get(i,None))
                if (((isA or isB) or isO) or isY):
                    base = python_internal_ArrayImpl._get(_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_BASE, j)
                    break
            result.append(base)
        result.reverse()
        return self.arrayToString(result)
...
class UyghurLanguageTools:
    _hx_class_name = "UyghurLanguageTools"
    __slots__ = ()
    _hx_statics = ["getVersion", "toExtended", "fromExtended", "toCommon", "toCyrillic", "toLatin", "fromCommon", "fromCyrillic", "fromLatin", "toAlphabet", "fromAlphabet", "doSyllable", "readNumber", "writeNumber", "main"]
    ...
    @staticmethod
    def main():
        print(str((("Uyghur Language Tools (" + HxOverrides.stringOrNull(UyghurLanguageTools.getVersion())) + "), for more infomation please visit https://github.com/kompasim")))


class _UyghurLanguageTools_UyghurLanguageTools_Fields_:
    _hx_class_name = "_UyghurLanguageTools.UyghurLanguageTools_Fields_"
    __slots__ = ()
...
def _hx_init__UyghurLanguageTools_UyghurLanguageTools_Fields__KEYCODES():
    def _hx_local_0():
        _g = haxe_ds_IntMap()
        _g.set(65,["a", "ھ", ""])
        _g.set(66,["b", "ب", ""])
        ...
        return _g
    return _hx_local_0()
_UyghurLanguageTools_UyghurLanguageTools_Fields_.KEYCODES = _hx_init__UyghurLanguageTools_UyghurLanguageTools_Fields__KEYCODES()
_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_BASE = ["ت", "پ", "ب", "ر", "د", "چ", "ج", "ز", "ف", "ق", "ك", "ش", "گ", "س", "ڭ", "ن", "م", "ۋ", "ل", "خ", "غ", "ژ", "ي", "ا", "ە", "و", "ۈ", "ۆ", "ۇ", "ې", "ى", "ھ", "ئ"]
_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_BEGIN = ["ﺗ", "ﭘ", "ﺑ", "ﺭ", "ﺩ", "ﭼ", "ﺟ", "ﺯ", "ﻓ", "ﻗ", "ﻛ", "ﺷ", "ﮔ", "ﺳ", "ﯕ", "ﻧ", "ﻣ", "ﯞ", "ﻟ", "ﺧ", "ﻏ", "ﮊ", "ﻳ", "ﺍ", "ﻩ", "ﻭ", "ﯛ", "ﯙ", "ﯗ", "ﯦ", "ﯨ", "ﮬ", "ﺋ"]
_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_SINGLE = ["ﺕ", "ﭖ", "ﺏ", "ﺭ", "ﺩ", "ﭺ", "ﺝ", "ﺯ", "ﻑ", "ﻕ", "ﻙ", "ﺵ", "ﮒ", "ﺱ", "ﯓ", "ﻥ", "ﻡ", "ﯞ", "ﻝ", "ﺥ", "ﻍ", "ﮊ", "ﻱ", "ﺍ", "ﻩ", "ﻭ", "ﯛ", "ﯙ", "ﯗ", "ﯤ", "ﻯ", "ﮪ", "ﺋ"]
_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_MIDDLE = ["ﺘ", "ﭙ", "ﺒ", "ﺮ", "ﺪ", "ﭽ", "ﺠ", "ﺰ", "ﻔ", "ﻘ", "ﻜ", "ﺸ", "ﮕ", "ﺴ", "ﯖ", "ﻨ", "ﻤ", "ﯟ", "ﻠ", "ﺨ", "ﻐ", "ﮋ", "ﻴ", "ﺎ", "ﻪ", "ﻮ", "ﯜ", "ﯚ", "ﯘ", "ﯧ", "ﯩ", "ﮭ", "ﺌ"]
_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_EXT_END = ["ﺖ", "ﭗ", "ﺐ", "ﺮ", "ﺪ", "ﭻ", "ﺞ", "ﺰ", "ﻒ", "ﻖ", "ﻚ", "ﺶ", "ﮓ", "ﺲ", "ﯔ", "ﻦ", "ﻢ", "ﯟ", "ﻞ", "ﺦ", "ﻎ", "ﮋ", "ﻲ", "ﺎ", "ﻪ", "ﻮ", "ﯜ", "ﯚ", "ﯘ", "ﯥ", "ﻰ", "ﮫ", "ﺌ"]
_UyghurLanguageTools_UyghurLanguageTools_Fields_.ALPHABET_FRIENDLY = ["ت", "ئ", "خ", "چ", "ج", "پ", "ب", "س", "ش", "غ", "ف", "ق", "ك", "گ", "ڭ", "ل", "م", "ن", "ھ", "ې", "ى", "ي"]
def _hx_init__UyghurLanguageTools_UyghurLanguageTools_Fields__REPLACE_MAP():
    def _hx_local_0():
        ...
        return _g
    return _hx_local_0()
_UyghurLanguageTools_UyghurLanguageTools_Fields_.REPLACE_MAP = _hx_init__UyghurLanguageTools_UyghurLanguageTools_Fields__REPLACE_MAP()
_UyghurLanguageTools_UyghurLanguageTools_Fields_.la1 = _UyghurLanguageTools_LA_Class("ﻟ","ﺎ","ﻻ")
_UyghurLanguageTools_UyghurLanguageTools_Fields_.la2 = _UyghurLanguageTools_LA_Class("ﻠ","ﺎ","ﻼ")
